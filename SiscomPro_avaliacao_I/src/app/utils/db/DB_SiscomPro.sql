...
/******** DELETAR REGISTROS DA TABELA CLIENTE E REINICIAR O ID **********/
-- DELETE FROM tb_clientes;
-- ALTER TABLE tb_clientes ALTER COLUMN id RESTART WITH 1;   

/******** POPULAR A TABELA CLIENTES **********/
INSERT INTO tb_clientes (nome, cpf, email, telefone, celular, cep, endereco, numero, bairro, cidade, estado) VALUES
...
('Julia Fernandes', '012345.67899', 'julia.fernandes@email.com', '1133224444', '11987654330', '10010000', 'Av. Rio Branco', 444, 'Centro', 'Ribeirão Preto', 'SP'),
